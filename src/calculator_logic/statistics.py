...
def sample_standard_deviation(number_list):
    ...
    Instead of using n like with population deviation, variance is calculated using n-1.
    """
    # if statement that accounts for 0 and 1 since n-1 results in negative values
    if len(number_list) < 2:
        raise ValueError("At least two data points are needed for sample standard deviation.")
